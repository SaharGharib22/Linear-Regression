...
plt.plot(X_train, y_pred_train, color='red', linewidth=2, label='Lasso fit')
plt.title('Training Data and Lasso Regression Fit')
plt.xlabel('X')
plt.ylabel('y')
plt.legend()
...
plt.plot(X_test, y_pred_test, color='red', linewidth=2, label='Lasso fit')
plt.title('Testing Data and Lasso Regression Fit')
plt.xlabel('X')
plt.ylabel('y')
plt.legend()
