...
sgd_regressor = SGDRegressor(loss='squared_error', max_iter=1000, learning_rate='constant', eta0=0.01, random_state=42)
...
plt.plot(X_train, y_pred_train, color='red', linewidth=2, label='SGD Regressor fit')
plt.title('Training Data and SGD Regressor Fit')
plt.xlabel('X')
plt.ylabel('y')
plt.legend()
...
plt.plot(X_test, y_pred_test, color='red', linewidth=2, label='SGD Regressor fit')
plt.title('Testing Data and SGD Regressor Fit')
plt.xlabel('X')
plt.ylabel('y')
plt.legend()
